...
params:
  studentID: "410584014"
  studentName: "江芊柔"
  repoURL: "你的作業github repo網址，為https://github.com/410584014chiang/inclassPractice"
---
...
```{r ans12}
library(stringr)
as.factor(gsHW2ws$ans1)->gsHW2ws$ans1
...
```{r ans14}
gsHW2ws$'答對率' <-rowSums(gsHW2ws[,1:4]==1, na.rm=T)/5*100 
```
